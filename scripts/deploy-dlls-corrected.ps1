# Custom DLL Deployment Script for Video Editor - CORRECTED VERSION
...
$platformFound = Get-ChildItem -Path $platformsDir -Name "qwindows*.dll" -ErrorAction SilentlyContinue
if ($platformFound) {
